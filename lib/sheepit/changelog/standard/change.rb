  ...
  class Changelog
    class Standard
      ...
      class Change
        ...
        #
        # Render the change as a Markdown string, with a leading bullet
        # character and split up into <80-character lines.
        #
        # @return [String] the change, ready to be dumped into a .md file
        #
        def to_s
          # A 79-character line can have up to 77 characters of description and
          # 2 of '- ' or indentation.
